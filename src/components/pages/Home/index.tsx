...
const IndexPage = props => {
    ...
    return (
        <>
            <Helmet>
                <link rel="canonical" href="https://www.rafaelrozon.com" />
            </Helmet>
            <HomeContainer>
                <SEO title="Rafael Rozon Website" lang="en" />
                <HomeMain>
                    ...
                    <MainText data-testid="main-text">
                        ...
                        <Paragraph>
                            I consider myself a Full Stack JavaScript developer,
                            but I'm a programmer before anything else and I'm
                            proud of being able to tackle problems in different
                            programming languages and stacks. I have experience
                            working with enterprise frontend development mainly
                            in React and Typescript and I also like DevOps,
                            Algorithms, Design Patterns, Testing, and the
                        ...
                        <Paragraph>
                            ...
                            Experience (DX). If you would like to know more,
                            sign up below and let's start a conversation.
                        </Paragraph>
